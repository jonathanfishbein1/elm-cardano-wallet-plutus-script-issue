					...
					if (_v0.d.$ === 'Just') {
						if (_v0.a.a.$ === 'Plutus') {
							...
							return function (x) {
								...
								var encodedLocalStateUtxos = $author$project$Bytes$Comparable$toHex(
									$author$project$Bytes$Comparable$fromBytes(
										$elm_toulouse$cbor$Cbor$Encode$encode(
											A2($elm_toulouse$cbor$Cbor$Encode$list, $author$project$Main$encodeTuple, localStateUtxosList))));
								var _v3 = A2(
									$elm$core$Debug$log,
									...
									$author$project$Bytes$Comparable$toHex(
										$author$project$Bytes$Comparable$fromBytes(
											$elm_toulouse$cbor$Cbor$Encode$encode(
												$author$project$Cardano$Utxo$encodeOutputReference(metadataScriptOutReference)))));
								var _v4 = A2(
									$elm$core$Debug$log,
									'metadataOutReference ',
									$author$project$Bytes$Comparable$toHex(
										$author$project$Bytes$Comparable$fromBytes(
											$elm_toulouse$cbor$Cbor$Encode$encode(
												$author$project$Cardano$Utxo$encodeOutputReference(metadataOutReference)))));
								var _v5 = A2($elm$core$Debug$log, 'localStateUtxos ', localUtxosWithMetadataScript.updatedState);
								var _v6 = A2($elm$core$Debug$log, 'localStateUtxosList ', localStateUtxosList);
								var _v7 = A2($elm$core$Debug$log, 'encodedLocalStateUtxos  ', encodedLocalStateUtxos);
								var _v8 = A2(
									$elm$core$Debug$log,
									'encodedPubKeyHash ',
									$author$project$Bytes$Comparable$toHex(pubKeyHash));
								var _v9 = A2($elm$core$Debug$log, 'txIntents ', x);
								return A3(
