					...
					if (_v0.d.$ === 'Just') {
						if (_v0.a.a.$ === 'Plutus') {
							...
							return function (x) {
								...
								var _v3 = A2($elm$core$Debug$log, 'localStateUtxos ', localUtxosWithMetadataScript.updatedState);
								var _v4 = A2($elm$core$Debug$log, 'localStateUtxosList ', localStateUtxosList);
								var _v5 = A2($elm$core$Debug$log, 'encodedLocalStateUtxos  ', encodedLocalStateUtxos);
								var _v6 = A2($elm$core$Debug$log, 'txIntents ', x);
								return A3(
