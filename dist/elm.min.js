...
var $author$project$Cardano$FailurePleaseReportToElmCardano = function (a) {
	return {$: 'FailurePleaseReportToElmCardano', a: a};
};
var $author$project$Cardano$FromPlutusScript = function (a) {
	return {$: 'FromPlutusScript', a: a};
};
var $author$project$Cardano$Script$PlutusV3 = {$: 'PlutusV3'};
var $author$project$Cardano$SendTo = F2(
	function (a, b) {
		return {$: 'SendTo', a: a, b: b};
	});
var $author$project$Cardano$Spend = function (a) {
	return {$: 'Spend', a: a};
};
...
var $author$project$Cardano$TxMetadata = function (a) {
	return {$: 'TxMetadata', a: a};
};
var $author$project$Cardano$WitnessByReference = function (a) {
	return {$: 'WitnessByReference', a: a};
};
...
var $author$project$Cardano$AutoFee = function (a) {
	return {$: 'AutoFee', a: a};
};
...
var $author$project$Cardano$GovProposalsNotSupportedInSimpleFinalize = {$: 'GovProposalsNotSupportedInSimpleFinalize'};
var $author$project$Cardano$assertNoGovProposals = function (intents) {
	...
	while (true) {
		if (!intents.b) {
			...
			if (intents.a.$ === 'Propose') {
				return $elm$core$Result$Err($author$project$Cardano$GovProposalsNotSupportedInSimpleFinalize);
			} else {
...
var $author$project$Cardano$credentialIsPlutusScript = function (cred) {
	if ((cred.$ === 'WithScript') && (cred.b.$ === 'PlutusWitness')) {
		return true;
	} else {
		return false;
	}
};
var $author$project$Cardano$containPlutusScripts = function (txIntents) {
		...
		if (!txIntents.b) {
			...
			switch (txIntents.a.$) {
				...
				case 'MintBurn':
					...
					var otherIntents = txIntents.b;
					if (scriptWitness.$ === 'NativeWitness') {
						var $temp$txIntents = otherIntents;
						txIntents = $temp$txIntents;
						continue containPlutusScripts;
					} else {
				...
				case 'IssueCertificate':
					switch (txIntents.a.a.$) {
						case 'RegisterStake':
							...
							var otherIntents = txIntents.b;
							if ($author$project$Cardano$credentialIsPlutusScript(delegator)) {
								return true;
							} else {
								var $temp$txIntents = otherIntents;
								txIntents = $temp$txIntents;
						...
						case 'RegisterDrep':
							...
							var otherIntents = txIntents.b;
							if ($author$project$Cardano$credentialIsPlutusScript(drep)) {
								return true;
							} else {
								var $temp$txIntents = otherIntents;
								txIntents = $temp$txIntents;
				...
				case 'WithdrawRewards':
					var scriptWitness = txIntents.a.a.scriptWitness;
					var otherIntents = txIntents.b;
					if ((scriptWitness.$ === 'Just') && (scriptWitness.a.$ === 'PlutusWitness')) {
						return true;
					} else {
						var $temp$txIntents = otherIntents;
						txIntents = $temp$txIntents;
					...
					while (true) {
						switch (voter.$) {
							case 'WithCommitteeHotCred':
								if ((voter.a.$ === 'WithScript') && (voter.a.b.$ === 'PlutusWitness')) {
									var _v7 = voter.a;
									return true;
								} else {
									break _v6$2;
...
var $author$project$Cardano$emptyGovernanceState = {guardrailsScript: $elm$core$Maybe$Nothing, lastEnactedCommitteeAction: $elm$core$Maybe$Nothing, lastEnactedConstitutionAction: $elm$core$Maybe$Nothing, lastEnactedHardForkAction: $elm$core$Maybe$Nothing, lastEnactedProtocolParamUpdateAction: $elm$core$Maybe$Nothing};
...
var $author$project$Cardano$ManualFee = function (a) {
	return {$: 'ManualFee', a: a};
};
var $author$project$Cardano$accumPerAddressSelection = function (allSelections) {
	return A3(
		$turboMaCk$any_dict$Dict$Any$foldl,
		F3(
			function (_v0, _v1, acc) {
				var selectedUtxos = _v1.a.selectedUtxos;
				var createdOutputs = _v1.b;
				return {
					createdOutputs: _Utils_ap(createdOutputs, acc.createdOutputs),
					selectedInputs: A3(
						$elm$core$List$foldl,
						function (_v2) {
							var ref = _v2.a;
		...
		{createdOutputs: _List_Nil, selectedInputs: $author$project$Cardano$Utxo$emptyRefDict},
		allSelections);
};
var $author$project$Cardano$UplcVmError = function (a) {
...
var $author$project$Cardano$adjustExecutionCosts = F2(
	function (evalScriptsCosts, tx) {
		return A2(
			...
			A2(
				...
				$author$project$Cardano$UplcVmError,
				evalScriptsCosts(tx)));
	});
...
var $author$project$Cardano$extractCertificateCred = function (cert) {
	switch (cert.$) {
		case 'StakeRegistrationCert':
			return _List_Nil;
		case 'StakeDeregistrationCert':
		...
		case 'AuthCommitteeHotCert':
			return _Debug_todo(
				'Cardano',
				{
					start: {line: 2852, column: 13},
					end: {line: 2852, column: 23}
				})('How many signatures for AuthCommitteeHotCert?');
		case 'ResignCommitteeColdCert':
			return _Debug_todo(
				'Cardano',
				{
					start: {line: 2855, column: 13},
					end: {line: 2855, column: 23}
...
var $author$project$Cardano$filterScriptVersion = function (v) {
...
var $author$project$Cardano$nothingIfEmptyList = function (list) {
	return $elm$core$List$isEmpty(list) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(list);
};
...
var $author$project$Cardano$split = F2(
	function (f, items) {
		return A3(
			$elm$core$List$foldr,
			F2(
...
var $author$project$Cardano$witnessSourceToResult = function (witnessSource) {
	if (witnessSource.$ === 'WitnessByValue') {
		var value = witnessSource.a;
...
var $author$project$Cardano$splitScripts = function (scripts) {
	return A2(
		$author$project$Cardano$split,
		function (_v0) {
			var v = _v0.a;
			var source = _v0.b;
			return A2(
				...
				$author$project$Cardano$witnessSourceToResult(source));
		},
		scripts);
};
...
var $author$project$Cardano$buildTx = F6(
	function (localStateUtxos, feeAmount, collateralSelection, processedIntents, otherInfo, txBody) {
		...
		var walletCredsInInputs = A2(
			...
			function (ref) {
				return A2(
					...
					A2(
						$elm$core$Basics$composeL,
						$author$project$Cardano$Address$extractPubKeyHash,
						function ($) {
							return $.address;
						}),
					A2($turboMaCk$any_dict$Dict$Any$get, ref, localStateUtxos));
		...
		var certificatesCreds = A2(
			...
			$author$project$Cardano$extractCertificateCred,
		...
		var _v0 = $author$project$Cardano$splitScripts(processedIntents.plutusScriptSources);
		var plutusScripts = _v0.a;
		var plutusScriptRefs = _v0.b;
		var _v1 = A2($author$project$Cardano$split, $author$project$Cardano$witnessSourceToResult, processedIntents.nativeScriptSources);
		var nativeScripts = _v1.a;
		var nativeScriptRefs = _v1.b;
		var _v2 = A2($author$project$Cardano$split, $author$project$Cardano$witnessSourceToResult, processedIntents.datumSources);
		...
		var allReferenceInputs = $turboMaCk$any_dict$Dict$Any$keys(
			$author$project$Cardano$Utxo$refDictFromList(
				A2(
					...
					$elm$core$List$concat(
						_List_fromArray(
							[txBody.referenceInputs, otherInfo.referenceInputs, nativeScriptRefs, plutusScriptRefs, datumWitnessRefs])))));
		var txWitnessSet = {
			bootstrapWitness: $elm$core$Maybe$Nothing,
			nativeScripts: $author$project$Cardano$nothingIfEmptyList(nativeScripts),
			plutusData: $author$project$Cardano$nothingIfEmptyList(datumWitnessValues),
			plutusV1Script: $author$project$Cardano$nothingIfEmptyList(
				A2($author$project$Cardano$filterScriptVersion, $author$project$Cardano$Script$PlutusV1, plutusScripts)),
			plutusV2Script: $author$project$Cardano$nothingIfEmptyList(
				A2($author$project$Cardano$filterScriptVersion, $author$project$Cardano$Script$PlutusV2, plutusScripts)),
			plutusV3Script: $author$project$Cardano$nothingIfEmptyList(
				A2($author$project$Cardano$filterScriptVersion, $author$project$Cardano$Script$PlutusV3, plutusScripts)),
			redeemer: $author$project$Cardano$nothingIfEmptyList(
				$elm$core$List$concat(
					_List_fromArray(
						[sortedSpendRedeemers, sortedMintRedeemers, sortedWithdrawalsRedeemers, certRedeemers, proposalRedeemers, voteRedeemers]))),
			vkeywitness: $author$project$Cardano$nothingIfEmptyList(placeholderVKeyWitness)
		};
		var updatedTxBody = {
...
var $author$project$Cardano$InsufficientManualFee = function (a) {
...
var $author$project$Cardano$checkInsufficientFee = F3(
	function (refSize, fee, tx) {
		...
		if (A2($dwayne$elm_natural$Natural$isLessThan, computedFee, declaredFee)) {
			if (fee.$ === 'ManualFee') {
				return $elm$core$Result$Err(
					$author$project$Cardano$InsufficientManualFee(
						{computed: computedFee, declared: declaredFee}));
			} else {
				return $elm$core$Result$Err(
					$author$project$Cardano$FailurePleaseReportToElmCardano('Insufficient AutoFee. Maybe we need another buildTx round?'));
			}
		} else {
...
var $author$project$Cardano$FailedToPerformCoinSelection = function (a) {
	return {$: 'FailedToPerformCoinSelection', a: a};
};
var $author$project$Cardano$NotEnoughMinAda = function (a) {
...
var $author$project$Cardano$defaultAutoFee = $dwayne$elm_natural$Natural$fromSafeInt(500000);
...
var $author$project$Cardano$resultDictJoin = function (dict) {
	return A3(
		$turboMaCk$any_dict$Dict$Any$foldl,
		function (key) {
...
var $author$project$Cardano$computeCoinSelection = F4(
	function (localStateUtxos, fee, processedIntents, coinSelectionAlgo) {
		var maxInputCount = 10;
		var dummyOutput = {
			address: $author$project$Cardano$Address$Byron(
				$author$project$Bytes$Comparable$fromHexUnchecked('')),
			amount: $author$project$Cardano$Value$zero,
			datumOption: $elm$core$Maybe$Nothing,
			referenceScript: $elm$core$Maybe$Nothing
		};
		var notAvailableInputs = A2(
			$turboMaCk$any_dict$Dict$Any$map,
			F2(
				function (_v6, _v7) {
					return dummyOutput;
		...
		var availableInputs = A3(
			...
			A2($turboMaCk$any_dict$Dict$Any$diff, localStateUtxos, notAvailableInputs));
		var addFee = F3(
		...
		var freeInputsWithFee = function () {
			if (fee.$ === 'ManualFee') {
				...
				return A3(
					$elm$core$List$foldl,
					function (_v5) {
						var paymentSource = _v5.paymentSource;
						var exactFeeAmount = _v5.exactFeeAmount;
				...
				return A3(addFee, paymentSource, $author$project$Cardano$defaultAutoFee, processedIntents.freeInputs);
			}
		}();
		...
		var validIndependentFreeOutputs = A2(
			$elm$core$Result$mapError,
			$author$project$Cardano$NotEnoughMinAda,
			$author$project$Cardano$resultDictJoin(
				A2(
					$turboMaCk$any_dict$Dict$Any$map,
					F2(
		...
		var targetValuesAndOutputs = function () {
			var whenOutput = F2(
				function (addr, v) {
					return A2(
						$turboMaCk$any_dict$Dict$Any$insert,
						addr,
						{freeOutput: v, targetInputValue: $author$project$Cardano$Value$zero});
				});
			var whenInput = F2(
				function (addr, v) {
					return A2(
						$turboMaCk$any_dict$Dict$Any$insert,
						addr,
						{freeOutput: $author$project$Cardano$Value$zero, targetInputValue: v});
				});
			var whenBoth = F3(
				function (addr, input, output) {
					return A2(
						$turboMaCk$any_dict$Dict$Any$insert,
						addr,
						{freeOutput: output, targetInputValue: input});
				});
		...
		var coinSelectionAndChangeOutputs = A2(
			$elm$core$Result$mapError,
			$author$project$Cardano$FailedToPerformCoinSelection,
			$author$project$Cardano$resultDictJoin(
				A2(
					$turboMaCk$any_dict$Dict$Any$map,
					F2(
						function (addr, _v0) {
							var targetInputValue = _v0.targetInputValue;
							var freeOutput = _v0.freeOutput;
							var hasFreeOutput = !_Utils_eq(freeOutput, $author$project$Cardano$Value$zero);
							var makeChangeOutput = function (selection) {
								var _v2 = _Utils_Tuple2(selection.change, hasFreeOutput);
								if ((_v2.a.$ === 'Nothing') && (!_v2.b)) {
									var _v3 = _v2.a;
									return $elm$core$Result$Ok(
										_Utils_Tuple2(selection, _List_Nil));
								} else {
									var change = A2(
										$author$project$Cardano$Value$add,
										A2($elm$core$Maybe$withDefault, $author$project$Cardano$Value$zero, selection.change),
										freeOutput);
									var changeOutput = {address: addr, amount: change, datumOption: $elm$core$Maybe$Nothing, referenceScript: $elm$core$Maybe$Nothing};
									var minAda = $author$project$Cardano$Utxo$minAda(changeOutput);
									return A2($dwayne$elm_natural$Natural$isGreaterThanOrEqual, minAda, change.lovelace) ? $elm$core$Result$Ok(
										_Utils_Tuple2(
											selection,
											_List_fromArray(
												[changeOutput]))) : $elm$core$Result$Err(
										$author$project$Cardano$CoinSelection$UTxOBalanceInsufficient(
											{
												missingValue: $author$project$Cardano$Value$onlyLovelace(
													A2($dwayne$elm_natural$Natural$sub, minAda, change.lovelace)),
												selectedUtxos: selection.selectedUtxos
											}));
								}
							};
							var guaranteedSelected = A2(
								$elm$core$List$filterMap,
								function (ref) {
									return A2(
										$elm$core$Maybe$map,
										function (output) {
											return _Utils_Tuple2(ref, output);
										},
										A2($turboMaCk$any_dict$Dict$Any$get, ref, localStateUtxos));
								},
								A2(
									$elm$core$Maybe$withDefault,
									_List_Nil,
									A2($turboMaCk$any_dict$Dict$Any$get, addr, processedIntents.guaranteedUtxos)));
							var availableUtxosDict = $author$project$Cardano$Utxo$refDictFromList(
								A2(
									$elm$core$Maybe$withDefault,
									_List_Nil,
									A2($turboMaCk$any_dict$Dict$Any$get, addr, availableInputs)));
							var context = F2(
								function (targetAmount, alreadySelected) {
									return {
										alreadySelectedUtxos: alreadySelected,
										availableUtxos: $turboMaCk$any_dict$Dict$Any$toList(
											A2(
												$turboMaCk$any_dict$Dict$Any$diff,
												availableUtxosDict,
												$author$project$Cardano$Utxo$refDictFromList(alreadySelected))),
										targetAmount: targetAmount
									};
								});
							var coinSelectIter = F2(
								function (targetValue, alreadySelected) {
									return A2(
										...
										A2(
											coinSelectionAlgo,
											maxInputCount,
											A2(context, targetValue, alreadySelected)));
								});
							var _v1 = A2(coinSelectIter, targetInputValue, guaranteedSelected);
							if ((_v1.$ === 'Err') && (_v1.a.$ === 'UTxOBalanceInsufficient')) {
								var err = _v1;
								var err1 = err.a.a;
								return $author$project$Cardano$MultiAsset$isEmpty(err1.missingValue.assets) ? A2(
									coinSelectIter,
									A2($author$project$Cardano$Value$add, targetInputValue, err1.missingValue),
									err1.selectedUtxos) : err;
							} else {
								var selectionResult = _v1;
				...
				F2(
					function (addr, output) {
						return A2(
							...
							addr,
							_Utils_Tuple2(
								{change: $elm$core$Maybe$Nothing, selectedUtxos: _List_Nil},
								_List_fromArray(
									[output])));
					})),
...
var $author$project$Cardano$CollateralSelectionError = function (a) {
...
var $author$project$Cardano$computeCollateralSelection = F3(
	function (localStateUtxos, collateralSources, collateralAmount) {
		var utxosInAllowedAddresses = A2(
			$elm$core$List$filter,
			function (_v9) {
				var output = _v9.b;
				return A2($turboMaCk$any_dict$Dict$Any$member, output.address, collateralSources);
			},
		...
		var _v2 = A2(
			...
			notAdaOnly);
		var assetsOnly = _v2.a;
		var notAssetsOnly = _v2.b;
		var _v4 = A2(
			$elm$core$List$partition,
			function (_v5) {
				var amount = _v5.b.amount;
				return A2($dwayne$elm_natural$Natural$isGreaterThan, adaOnlyThreshold, amount.lovelace);
			},
			adaOnly);
		var highAdaOnly = _v4.a;
		var lowAdaOnly = _v4.b;
		...
		return A2(
			$elm$core$Result$mapError,
			$author$project$Cardano$CollateralSelectionError,
			A2(
				...
				maxInputCount,
				{
					...
					targetAmount: $author$project$Cardano$Value$onlyLovelace(collateralAmount)
				}));
	});
var $elm$core$List$sum = function (numbers) {
	return A3($elm$core$List$foldl, $elm$core$Basics$add, 0, numbers);
};
var $author$project$Cardano$computeRefScriptBytes = F2(
...
var $author$project$Cardano$ReferenceOutputsMissingFromLocalState = function (a) {
	return {$: 'ReferenceOutputsMissingFromLocalState', a: a};
};
var $author$project$Cardano$UnbalancedIntents = function (a) {
	return {$: 'UnbalancedIntents', a: a};
};
...
var $author$project$Cardano$actionFromIntent = F2(
...
var $author$project$Cardano$addPreSelectedInput = F4(
...
var $author$project$Cardano$encodeWitnessSource = F2(
...
var $author$project$Cardano$extractWitnessRef = function (witnessSource) {
	if (witnessSource.$ === 'WitnessByValue') {
		return $elm$core$Maybe$Nothing;
	} else {
		var ref = witnessSource.a;
...
var $author$project$Cardano$noIntent = {
...
var $author$project$Cardano$preprocessCert = F5(
...
var $author$project$Cardano$preProcessIntents = function (txIntents) {
	var freeValueAdd = F3(
		...
		function (txIntent, preProcessedIntents) {
			switch (txIntent.$) {
				...
				case 'SendToOutput':
					...
					var newPreCreated = function (txBody) {
						var _v1 = preProcessedIntents.preCreated(txBody);
						var sum = _v1.sum;
				...
				case 'SendToOutputAdvanced':
					var f = txIntent.a;
					var newPreCreated = function (txBody) {
						var newOutput = f(txBody);
						var _v2 = preProcessedIntents.preCreated(txBody);
						var sum = _v2.sum;
					...
					switch (txIntent.a.$) {
						...
						case 'FromNativeScript':
							...
							return _Utils_update(
								preProcessedIntents,
								{
									nativeScriptSources: A2($elm$core$List$cons, nativeScriptWitness, preProcessedIntents.nativeScriptSources),
									preSelected: A2(
										$elm$core$List$cons,
				...
				case 'WithdrawRewards':
					...
					if (scriptWitness.$ === 'Nothing') {
						...
						if (scriptWitness.a.$ === 'NativeWitness') {
				...
				case 'IssueCertificate':
					switch (txIntent.a.$) {
						case 'RegisterStake':
							...
							return A5(
								$author$project$Cardano$preprocessCert,
								function (keyCred) {
					...
					switch (txIntent.a.$) {
						case 'WithCommitteeHotCred':
							if (txIntent.a.a.$ === 'WithKey') {
								...
								if (txIntent.a.a.b.$ === 'NativeWitness') {
	...
	return A3($elm$core$List$foldr, stepIntent, $author$project$Cardano$noIntent, txIntents);
};
var $author$project$Cardano$proposalRedeemer = function (govAction) {
	switch (govAction.$) {
		case 'ParameterChange':
			return $elm$core$Maybe$Just(
...
var $author$project$Cardano$validMinAdaPerOutput = function (outputs) {
...
var $author$project$Cardano$DatumHashMismatch = F2(
	function (a, b) {
		return {$: 'DatumHashMismatch', a: a, b: b};
	});
var $author$project$Cardano$ExtraneousDatumWitness = F2(
	function (a, b) {
		return {$: 'ExtraneousDatumWitness', a: a, b: b};
	});
var $author$project$Cardano$MissingDatumWitness = F2(
	function (a, b) {
		return {$: 'MissingDatumWitness', a: a, b: b};
	});
...
var $author$project$Cardano$getUtxo = F2(
	function (utxos, ref) {
		return A2(
			$elm$core$Result$fromMaybe,
			$author$project$Cardano$ReferenceOutputsMissingFromLocalState(
				_List_fromArray(
					[ref])),
...
var $author$project$Cardano$checkDatumWitness = F3(
	function (localStateUtxos, maybeDatumOption, maybeDatumWitness) {
		...
		if (_v0.a.$ === 'Nothing') {
			if (_v0.b.$ === 'Nothing') {
				...
				return $elm$core$Result$Err(
					A2($author$project$Cardano$ExtraneousDatumWitness, datumWitness, 'Datum witness was provided but the corresponding UTxO has no datum'));
			}
		} else {
			if (_v0.a.a.$ === 'DatumValue') {
				if (_v0.b.$ === 'Nothing') {
					...
					var datumWitness = _v0.b.a;
					return $elm$core$Result$Err(
						A2($author$project$Cardano$ExtraneousDatumWitness, datumWitness, 'Datum witness was provided but the corresponding UTxO already has a datum provided by value'));
				}
			} else {
				if (_v0.b.$ === 'Nothing') {
					...
					var _v5 = _v0.b;
					return $elm$core$Result$Err(
						A2($author$project$Cardano$MissingDatumWitness, datumHash, 'Datum in UTxO is a hash, but no witness was provided'));
				} else {
					var datumHash = _v0.a.a.a;
					var witness = _v0.b.a;
					var checkDatumMatch = function (hashes) {
						return _Utils_eq(hashes.expected, hashes.witness) ? $elm$core$Result$Ok(_Utils_Tuple0) : $elm$core$Result$Err(
							A2($author$project$Cardano$DatumHashMismatch, hashes, 'Provided witness has wrong datum hash. Maybe you provided the wrong witness Data, or it is encoded differently than the original one.'));
					};
					if (witness.$ === 'WitnessByValue') {
						var data = witness.a;
						...
						var checkDatumOption = function (datumOption) {
							if (datumOption.$ === 'Nothing') {
								return $elm$core$Result$Err(
									A2($author$project$Cardano$MissingDatumWitness, datumHash, 'The referenced UTxO presented as witness does not contain a datum'));
							} else {
								if (datumOption.a.$ === 'DatumHash') {
									return $elm$core$Result$Err(
										A2($author$project$Cardano$MissingDatumWitness, datumHash, 'The referenced UTxO presented as witness contains a datum hash again instead of a datum value'));
								} else {
						...
						return A2(
							...
							A2($author$project$Cardano$getUtxo, localStateUtxos, utxoRef));
					}
				}
			}
		}
...
var $author$project$Cardano$InvalidWalletAddress = F2(
	function (a, b) {
		return {$: 'InvalidWalletAddress', a: a, b: b};
	});
var $author$project$Cardano$checkAddress = F2(
	function (address, credentialValidator) {
		switch (address.$) {
			case 'Byron':
				return $elm$core$Result$Err(
					A2($author$project$Cardano$InvalidWalletAddress, address, 'Byron addresses not supported'));
			case 'Reward':
				return $elm$core$Result$Err(
					A2($author$project$Cardano$InvalidWalletAddress, address, 'Reward address cannot be spent'));
			default:
				var paymentCredential = address.a.paymentCredential;
				return credentialValidator(paymentCredential);
		}
	});
var $author$project$Cardano$checkScriptAddress = function (address) {
	return A2(
		$author$project$Cardano$checkAddress,
		address,
		function (credential) {
			if (credential.$ === 'VKeyHash') {
				return $elm$core$Result$Err(
					A2($author$project$Cardano$InvalidWalletAddress, address, 'This is a regular wallet key address, not a script address'));
			} else {
...
var $author$project$Cardano$ScriptHashMismatch = F2(
	function (a, b) {
		return {$: 'ScriptHashMismatch', a: a, b: b};
	});
var $author$project$Cardano$checkScriptMatch = function (hashes) {
	return _Utils_eq(hashes.expected, hashes.witness) ? $elm$core$Result$Ok(_Utils_Tuple0) : $elm$core$Result$Err(
		A2($author$project$Cardano$ScriptHashMismatch, hashes, 'Provided witness has wrong script hash'));
};
var $author$project$Cardano$MissingReferenceScript = function (a) {
	return {$: 'MissingReferenceScript', a: a};
};
var $author$project$Cardano$getRefScript = F2(
	function (localStateUtxos, ref) {
		return A2(
			...
			A2(
				...
				$elm$core$Result$fromMaybe(
					$author$project$Cardano$MissingReferenceScript(ref))),
			A2($author$project$Cardano$getUtxo, localStateUtxos, ref));
	});
...
var $author$project$Cardano$checkNativeScriptSpending = F3(
	function (localStateUtxos, spentInput, nativeScriptWitness) {
		return A2(
			$elm$core$Result$andThen,
			function (scriptHash) {
				if (nativeScriptWitness.$ === 'WitnessByValue') {
					var nativeScript = nativeScriptWitness.a;
					return $author$project$Cardano$checkScriptMatch(
						{
							expected: scriptHash,
					...
					var outputRef = nativeScriptWitness.a;
					return A2(
						$elm$core$Result$andThen,
						function (refScript) {
							return $author$project$Cardano$checkScriptMatch(
								{
									expected: scriptHash,
									witness: $author$project$Cardano$Script$refHash(refScript)
								});
						},
						A2($author$project$Cardano$getRefScript, localStateUtxos, outputRef));
				}
			},
			$author$project$Cardano$checkScriptAddress(spentInput.address));
	});
var $author$project$Cardano$InvalidScriptRef = F3(
	function (a, b, c) {
...
var $author$project$Cardano$checkPlutusScriptSpending = F3(
		...
		return A2(
			...
			function (scriptHash) {
				...
				if (witnessSource.$ === 'WitnessByValue') {
					...
					return $author$project$Cardano$checkScriptMatch(
						{expected: scriptHash, witness: computedScriptHash});
				} else {
					var outputRef = witnessSource.a;
					var checkValidScript = function (scriptRef) {
						var scriptBytes = $author$project$Cardano$Script$refBytes(scriptRef);
						var _v2 = A2(
							$elm_toulouse$cbor$Cbor$Decode$decode,
							$author$project$Cardano$Script$fromCbor,
							$author$project$Bytes$Comparable$toBytes(scriptBytes));
						if (_v2.$ === 'Just') {
							return $elm$core$Result$Ok(scriptRef);
						} else {
							return $elm$core$Result$Err(
								A3($author$project$Cardano$InvalidScriptRef, outputRef, scriptBytes, 'UTxO contains an invalid reference script (bytes cannot be decoded into an actual script)'));
						}
					};
					return A2(
						$elm$core$Result$andThen,
...
var $author$project$Cardano$checkKeyAddress = function (address) {
	return A2(
		$author$project$Cardano$checkAddress,
		address,
		function (credential) {
			if (credential.$ === 'VKeyHash') {
				...
				return $elm$core$Result$Err(
					A2($author$project$Cardano$InvalidWalletAddress, address, 'This is a script address, not a regular wallet key address'));
			}
		});
};
...
var $author$project$Cardano$checkWalletSpending = F2(
	function (localStateUtxos, _v0) {
		...
		var checkRefAddressIsKey = function (ref) {
			return A2(
				$elm$core$Result$andThen,
				function (output) {
					return $author$project$Cardano$checkKeyAddress(output.address);
				},
				A2($author$project$Cardano$getUtxo, localStateUtxos, ref));
		};
		return A2(
			...
			$author$project$Cardano$checkKeyAddress(address));
	});
var $author$project$Cardano$checkSpentSource = F2(
	function (localStateUtxos, spending) {
		switch (spending.$) {
			case 'FromWallet':
				var walletSpending = spending.a;
				return A2($author$project$Cardano$checkWalletSpending, localStateUtxos, walletSpending);
			case 'FromNativeScript':
				...
				return A2(
					$elm$core$Result$andThen,
					function (output) {
						return A3($author$project$Cardano$checkNativeScriptSpending, localStateUtxos, output, nativeScriptWitness);
					},
					A2($author$project$Cardano$getUtxo, localStateUtxos, spentInput));
			default:
				var spentInput = spending.a.spentInput;
				...
				return A2(
					...
					function (output) {
						return A2(
							$elm$core$Result$andThen,
							function (_v1) {
								return A3($author$project$Cardano$checkPlutusScriptSpending, localStateUtxos, output, plutusScriptWitness);
							},
							A3($author$project$Cardano$checkDatumWitness, localStateUtxos, output.datumOption, datumWitness));
					},
					A2($author$project$Cardano$getUtxo, localStateUtxos, spentInput));
		}
	});
var $author$project$Cardano$validateSpentOutputs = F2(
	function (localStateUtxos, spendings) {
		return A2(
			...
			$elm_community$result_extra$Result$Extra$combine(
				A2(
					$elm$core$List$map,
					$author$project$Cardano$checkSpentSource(localStateUtxos),
					spendings)));
	});
...
var $author$project$Cardano$processIntents = F3(
	function (govState, localStateUtxos, txIntents) {
		...
		var preProcessedIntents = $author$project$Cardano$preProcessIntents(txIntents);
		...
		var totalWithdrawalAmount = A3(
			...
			$dwayne$elm_natural$Natural$zero,
			preProcessedIntents.withdrawals);
		var voterDict = $author$project$Cardano$Gov$voterDictFromList(
			A2(
				$elm$core$List$map,
				function (_v15) {
					var voter = _v15.voter;
					var votes = _v15.votes;
					var redeemer = _v15.redeemer;
					return _Utils_Tuple2(
						voter,
						{redeemer: redeemer, votes: votes});
				},
				preProcessedIntents.votes));
		var preCreated = function (txBody) {
			var _v14 = preProcessedIntents.preCreated(txBody);
			var sum = _v14.sum;
			var outputs = _v14.outputs;
			return {
				outputs: outputs,
				sum: A2($author$project$Cardano$Value$add, sum, totalBurnedValue)
			};
		};
		var preCreatedOutputs = preCreated($author$project$Cardano$Transaction$newBody);
		var totalOutput = A2(
			$author$project$Cardano$Value$add,
		...
		var plutusScriptSources = function () {
			if (A2($elm$core$List$any, requiresGuardrails, preProcessedIntents.proposalIntents)) {
				var _v12 = govState.guardrailsScript;
				if (_v12.$ === 'Just') {
					var plutusVersion = _v12.a.plutusVersion;
					var scriptWitness = _v12.a.scriptWitness;
					return A2(
						$elm$core$List$cons,
						_Utils_Tuple2(plutusVersion, scriptWitness),
						preProcessedIntents.plutusScriptSources);
				} else {
					return preProcessedIntents.plutusScriptSources;
				}
			} else {
				return preProcessedIntents.plutusScriptSources;
			}
		...
		var preSelected = A3(
			...
			function (s) {
				return A3(
					$author$project$Cardano$addPreSelectedInput,
					s.input,
				...
				$elm$core$List$concat(
					_List_fromArray(
						[
							...
							A2($elm$core$List$filterMap, $author$project$Cardano$extractWitnessRef, preProcessedIntents.nativeScriptSources),
							A2(
							$elm$core$List$filterMap,
							$author$project$Cardano$extractWitnessRef,
							A2(
								$elm$core$List$map,
								function (_v10) {
									var source = _v10.b;
								...
								plutusScriptSources)),
							A2($elm$core$List$filterMap, $author$project$Cardano$extractWitnessRef, preProcessedIntents.datumSources)
						]))));
		...
		if (!$turboMaCk$any_dict$Dict$Any$isEmpty(absentOutputReferencesInLocalState)) {
			...
			if (!_Utils_eq(totalInput, totalOutput)) {
				var _v0 = A2($elm$core$Debug$log, 'totalInput', totalInput);
				var _v1 = A2($elm$core$Debug$log, 'totalOutput', totalOutput);
				return $elm$core$Result$Err(
					$author$project$Cardano$UnbalancedIntents('Tx is not balanced.\n'));
			} else {
						...
						function (ref, acc) {
							return A2(
								...
								A2(
									$elm$core$Maybe$map,
									function (_v5) {
										var address = _v5.address;
										var _v6 = A2($turboMaCk$any_dict$Dict$Any$get, address, acc);
										if (_v6.$ === 'Nothing') {
											return A3(
												$turboMaCk$any_dict$Dict$Any$insert,
												address,
											...
											return A3(
												$turboMaCk$any_dict$Dict$Any$insert,
												address,
												A2($elm$core$List$cons, ref, refs),
												acc);
										}
									},
									A2($turboMaCk$any_dict$Dict$Any$get, ref, localStateUtxos)));
				...
				return A2(
					...
					function (_v3) {
						var witnessToHex = F2(
							function (encoder, source) {
								return $author$project$Bytes$Comparable$toHex(
									$author$project$Bytes$Comparable$fromBytes(
										$elm_toulouse$cbor$Cbor$Encode$encode(
											A2($author$project$Cardano$encodeWitnessSource, encoder, source))));
							});
						...
						return {
							...
							datumSources: A2(
								...
								witnessToHex($author$project$Cardano$Data$toCbor),
							...
							nativeScriptSources: A2(
								$elm_community$list_extra$List$Extra$uniqueBy,
								witnessToHex($author$project$Cardano$Script$encodeNativeScript),
							...
							plutusScriptSources: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$elm$core$Tuple$second,
									witnessToHex($author$project$Bytes$Comparable$toCbor)),
								plutusScriptSources),
							...
							proposals: A2(
								$elm$core$List$map,
								function (_v4) {
									var govAction = _v4.govAction;
									var offchainInfo = _v4.offchainInfo;
									var deposit = _v4.deposit;
									var depositReturnAccount = _v4.depositReturnAccount;
									return _Utils_Tuple2(
										{
											anchor: offchainInfo,
											deposit: deposit,
											depositReturnAccount: depositReturnAccount,
											govAction: A2($author$project$Cardano$actionFromIntent, govState, govAction)
										},
										$author$project$Cardano$proposalRedeemer(govAction));
								},
					...
					A2(
						$elm$core$Result$andThen,
						function (_v2) {
							return A2($author$project$Cardano$validateSpentOutputs, localStateUtxos, spendings);
						},
						A2(
							$elm$core$Result$mapError,
							$author$project$Cardano$NotEnoughMinAda,
							$author$project$Cardano$validMinAdaPerOutput(preCreatedOutputs.outputs))));
			}
		}
	});
var $author$project$Cardano$DuplicatedMetadataTags = function (a) {
	return {$: 'DuplicatedMetadataTags', a: a};
};
var $author$project$Cardano$IncorrectTimeValidityRange = function (a) {
...
var $author$project$Cardano$noInfo = {metadata: _List_Nil, referenceInputs: _List_Nil, timeValidityRange: $elm$core$Maybe$Nothing};
...
var $author$project$Cardano$processOtherInfo = function (otherInfo) {
	...
	if (hasDuplicatedMetadataTags) {
		...
		return $elm$core$Result$Err(
			$author$project$Cardano$DuplicatedMetadataTags(dupTag));
	} else {
		if (!validTimeRange) {
			return $elm$core$Result$Err(
				$author$project$Cardano$IncorrectTimeValidityRange(
...
var $author$project$Cardano$replaceDummyAuxiliaryDataHash = function (tx) {
	var body = tx.body;
...
var $author$project$Cardano$replaceDummyScriptDataHash = F3(
...
var $author$project$Cardano$updateTxBody = F3(
	function (intents, _v0, old) {
		var selectedInputs = _v0.selectedInputs;
		var createdOutputs = _v0.createdOutputs;
		return _Utils_update(
			old,
			{
				inputs: function () {
					...
					var algoSelected = A2(
						...
						selectedInputs);
					return $turboMaCk$any_dict$Dict$Any$keys(
						A2($turboMaCk$any_dict$Dict$Any$union, preSelected, algoSelected));
				}(),
				outputs: _Utils_ap(
					intents.preCreated(old).outputs,
					createdOutputs)
			});
	});
var $author$project$Cardano$finalizeAdvanced = F4(
	function (_v0, fee, txOtherInfo, txIntents) {
		...
		var _v1 = _Utils_Tuple2(
			A3($author$project$Cardano$processIntents, govState, localStateUtxos, txIntents),
			$author$project$Cardano$processOtherInfo(txOtherInfo));
		if (_v1.a.$ === 'Err') {
			var err = _v1.a.a;
			return $elm$core$Result$Err(err);
		} else {
			if (_v1.b.$ === 'Err') {
				...
				var computeRefScriptBytesForTx = function (tx) {
					return A2(
						$author$project$Cardano$computeRefScriptBytes,
						localStateUtxos,
						_Utils_ap(tx.body.referenceInputs, tx.body.inputs));
				};
				var buildTxRound = F2(
					function (roundTxBody, roundFees) {
						var _v8 = function () {
							if (roundFees.$ === 'ManualFee') {
								...
								return _Utils_Tuple2(
									$author$project$Cardano$defaultAutoFee,
									_List_fromArray(
										[paymentSource]));
							}
						}();
						...
						return A3(
							...
							F2(
								function (coinSelection, collateralSelection) {
									return A6(
										$author$project$Cardano$buildTx,
										localStateUtxos,
										feeAmount,
										collateralSelection,
										processedIntents,
										processedOtherInfo,
										function (selection) {
											return A3($author$project$Cardano$updateTxBody, processedIntents, selection, roundTxBody);
										}(
											$author$project$Cardano$accumPerAddressSelection(coinSelection)));
								}),
							A4($author$project$Cardano$computeCoinSelection, localStateUtxos, roundFees, processedIntents, coinSelectionAlgo),
							A3($author$project$Cardano$computeCollateralSelection, localStateUtxos, collateralSources, collateralAmount));
					});
				var adjustFees = function (tx) {
					if (fee.$ === 'ManualFee') {
						...
						return function (computedFee) {
							return $author$project$Cardano$ManualFee(
								_List_fromArray(
									[
				...
				return A2(
					...
					function (_v5) {
						...
						return A2(
							...
							A2(
								...
								function (finalTx) {
									return A3(
										$author$project$Cardano$checkInsufficientFee,
										{
								...
								A2(
									$elm$core$Result$map,
									A2($author$project$Cardano$replaceDummyScriptDataHash, costModels, processedIntents),
									A2(
										$elm$core$Result$map,
										$author$project$Cardano$replaceDummyAuxiliaryDataHash,
										$author$project$Cardano$adjustExecutionCosts(
					...
					A2(
						...
						A2(
							...
							function (_v4) {
								var tx = _v4.tx;
								return $author$project$Cardano$adjustExecutionCosts(
									evalScriptsCosts(localStateUtxos))(tx);
							},
							A2(
								$elm$core$Result$andThen,
								...
								A2(
									...
									A2(
										...
										A2(buildTxRound, $author$project$Cardano$Transaction$newBody, fee)))))));
			}
		}
	});
var $author$project$Cardano$UnableToGuessFeeSource = {$: 'UnableToGuessFeeSource'};
var $author$project$Cardano$guessFeeSource = function (txIntents) {
	...
	if (_v3.$ === 'Just') {
		...
		if (_v4.$ === 'Just') {
			...
			return $elm$core$Result$Err($author$project$Cardano$UnableToGuessFeeSource);
		}
	}
};
...
var $author$project$Cardano$finalize = F3(
	function (localStateUtxos, txOtherInfo, txIntents) {
		return A2(
			$elm$core$Result$andThen,
			function (feeSource) {
				var defaultEvalScriptsCosts = function () {
					if ($author$project$Cardano$containPlutusScripts(txIntents)) {
						var network = function () {
							switch (feeSource.$) {
								case 'Byron':
									return _Debug_todo(
										'Cardano',
										{
											start: {line: 691, column: 45},
											end: {line: 691, column: 55}
				...
				return A4(
					$author$project$Cardano$finalizeAdvanced,
					{coinSelectionAlgo: $author$project$Cardano$CoinSelection$largestFirst, costModels: $author$project$Cardano$Uplc$conwayDefaultCostModels, evalScriptsCosts: defaultEvalScriptsCosts, govState: $author$project$Cardano$emptyGovernanceState, localStateUtxos: localStateUtxos},
					$author$project$Cardano$AutoFee(
			...
			A2(
				$elm$core$Result$andThen,
				function (_v0) {
					return $author$project$Cardano$guessFeeSource(txIntents);
				},
				$author$project$Cardano$assertNoGovProposals(txIntents)));
	});
...
var $author$project$Cardano$updateLocalState = F3(
						...
						if (_v0.a.a.$ === 'Plutus') {
							...
							var plutusScriptWitness = {
								...
								script: _Utils_Tuple2(
									...
									$author$project$Cardano$WitnessByReference(metadataScriptOutReference))
							};
							var metadata = $author$project$Cardano$TxMetadata(
								{
							...
							var localUtxosWithReferenceScript = A3(
								$author$project$Cardano$updateLocalState,
							...
							var localUtxosWithMetadataScript = A3($author$project$Cardano$updateLocalState, metadataOutReference.transactionId, metadataTransaction, localUtxosWithReferenceScript.updatedState);
							var _v2 = A2($elm$core$Debug$log, 'metadataOutput ', metadataOutput);
							return function (x) {
								return A3(
									$author$project$Cardano$finalize,
								...
								_List_fromArray(
									[
										$author$project$Cardano$Spend(
										$author$project$Cardano$FromPlutusScript(
											{datumWitness: $elm$core$Maybe$Nothing, plutusScriptWitness: plutusScriptWitness, spentInput: metadataOutReference})),
										A2($author$project$Cardano$SendTo, wallet.changeAddress, $author$project$Main$threeAda)
									]));
						} else {
							return $elm$core$Result$Err(
								$author$project$Cardano$FailurePleaseReportToElmCardano('other issue'));
						}
					} else {
						var _v6 = _v0.d;
						return $elm$core$Result$Err(
							$author$project$Cardano$FailurePleaseReportToElmCardano('missing pubKeyHash'));
					}
				} else {
					var _v5 = _v0.c;
					return $elm$core$Result$Err(
						$author$project$Cardano$FailurePleaseReportToElmCardano('missing metadata reference'));
				}
			} else {
				var _v4 = _v0.b;
				return $elm$core$Result$Err(
					$author$project$Cardano$FailurePleaseReportToElmCardano('missing metadata utxo'));
			}
		} else {
			var e = _v0.a.a;
			return $elm$core$Result$Err(
				$author$project$Cardano$FailurePleaseReportToElmCardano('missing address'));
		}
	});
...
var $author$project$Cardano$FromWallet = function (a) {
	return {$: 'FromWallet', a: a};
};
var $author$project$Cardano$SendToOutput = function (a) {
			...
			switch (_v0.a.$) {
				...
				case 'CloseMetadata':
					if (_v0.b.$ === 'WaitingForInput') {
						var _v17 = _v0.a;
						var wallet = _v0.b.a;
						var _v18 = $author$project$Main$metadataScriptResult($author$project$Main$metadataScriptString);
						if (_v18.$ === 'Ok') {
							var metadataScript = _v18.a;
							var metadataScriptHash = $author$project$Cardano$Script$hash(metadataScript);
							var metadataScriptAddress = A2($author$project$Cardano$Address$script, $author$project$Cardano$Address$Testnet, metadataScriptHash);
							return _Utils_Tuple2(
								model,
				...
				default:
					if (_v0.b.$ === 'WaitingForInput') {
						var x = _v0.a.a;
						var wallet = _v0.b.a;
						var _v20 = A2($elm$core$Debug$log, 'in RecieveCloseMetadata ', x);
						if ((x.$ === 'Ok') && (x.a.$ === 'Ok')) {
							var validTx = x.a.a;
							return _Utils_Tuple2(
