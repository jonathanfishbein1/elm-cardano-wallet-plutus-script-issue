			...
			switch (_v0.a.$) {
				...
				case 'CloseMetadata':
					if (_v0.b.$ === 'WaitingForInput') {
						var _v7 = _v0.a;
						var wallet = _v0.b.a;
						var _v8 = $author$project$Main$metadataScriptResult($author$project$Main$metadataScriptString);
						if (_v8.$ === 'Ok') {
							var metadataScript = _v8.a;
				...
				default:
					if (_v0.b.$ === 'WaitingForInput') {
						var x = _v0.a.a;
						var wallet = _v0.b.a;
						var _v10 = A2($elm$core$Debug$log, 'in RecieveCloseMetadata ', x);
						if ((x.$ === 'Ok') && (x.a.$ === 'Ok')) {
							var validTx = x.a.a;
							return _Utils_Tuple2(
