			...
			switch (_v0.a.$) {
				...
				case 'CloseMetadata':
					if (_v0.b.$ === 'WaitingForInput') {
						var _v6 = _v0.a;
						var wallet = _v0.b.a;
						var _v7 = $author$project$Main$metadataScriptResult($author$project$Main$metadataScriptString);
						if (_v7.$ === 'Ok') {
							var metadataScript = _v7.a;
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('send script to wallet as reference script')
							]))
					]));
		default:
